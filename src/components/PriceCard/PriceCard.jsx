...
const PriceCard = ({price}) => {
    return (
        <div className='bg-indigo-300 mt-4 rounded-md p-4 flex flex-col'>
            ...
            <p className='font-bold text-2xl text-white underline'>Features</p>
            {
            ...
            <button className='w-full mt-auto bg-green-500 hover:bg-slate-600 py-2 
                rounded-md text-white font-bold'>Buy Now</button>
        </div>
    );
};
